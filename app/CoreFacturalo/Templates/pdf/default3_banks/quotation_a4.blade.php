...
$logo = "{$establishment->logo}";
    ...
    // dd($document->exchange_rate_sale);
@endphp
<html>
    ...
    <table class="full-width mt-10 mb-10">
        ...
        <tbody>
            ...
            @if($document->currency_type->id=='USD')
                <tr>
                    <td colspan="8" class="text-right font-bold">TOTAL A PAGAR: S/
                    </td>
                    <td class="text-right font-bold">{{ number_format($document->total*$document->exchange_rate_sale, 2) }}</td>
                </tr>
            @endif
        </tbody>
    </table>

...
<body>
    ...
    <table class="full-width mt-10 mb-10">
        ...
        <tbody>
            ...
            <tr>
                <td colspan="8" class="text-right font-bold">{{(($document->total_prepayment > 0) ? 'ANTICIPO':'DESCUENTO TOTAL')}}
            ...
            <tr>
                <td colspan="8" class="text-right font-bold" style="font-size: 16px;">IMPORTE TOTAL: {{ $document->currency_type->symbol }}</td>
    ...
    <table class="full-width">
        ...
        <tbody>
            <tr>
                @if ($configuration->yape_qr_documents)
                    @php
                ...
                @endif
                @if ($configuration->plin_qr_documents)
                    @php

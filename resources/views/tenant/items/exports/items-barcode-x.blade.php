        ...
        <div class="">
            <div class=" ">
                <table class="table" style="margin:0px; padding:0px;overflow: wrap;" width="100%" autosize="1">>
                    ...
                    @elseif($format == 4)
                        <td style="text-align:center;padding:0px;width:450px;">
                            {{-- <div style="text-align: center;">
                                <div style="font-size: 16px; text-align: center; min-height: 250px; ">
                                    {{ $record->second_name }}
                                ...
                                >
                                   @php
                                       $colour = [0, 0, 0];
                                       $generator = new \Picqer\Barcode\BarcodeGeneratorPNG();
                                       echo '<img style="" src="data:image/png;base64,' . base64_encode($generator->getBarcode($record->barcode, $generator::TYPE_CODE_128,4, 160, $colour)) . '">';
                                   @endphp
                               </div>
                               <div>
